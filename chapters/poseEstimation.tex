...
Pose estimation frameworks typically use a mixture of ideas from two categories: generative and discriminative, which can also be called top-down and bottom-up respectively. 
